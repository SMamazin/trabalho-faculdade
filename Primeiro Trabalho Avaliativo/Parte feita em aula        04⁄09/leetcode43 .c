...
char *multiply( char *num1, char *num2 ) {
	...
	{
		int maxvar1 = strlen(num1);
		int maxvar2 = strlen(num2);
		printf("v1:%d e v2:%d\n", maxvar1, maxvar2);

		int* valor1 = (int*) malloc (maxvar1 * sizeof(int));
		int* valor2 = (int*) malloc (maxvar2 * sizeof(int));

		for (int i = 0; i > maxvar1; i++)
		{
			valor1[i] = *num1 - 48;
			valor2[i] = *num2 - 48;
			x = valor1[i] * valor2[i];
	...
	char* res = (char*) malloc (x * sizeof(char));
	return res;
}
